...
import cn.org.atool.fluent.mybatis.tutorial.helper.ReceivingAddressWrapperHelper.*;
...
public class ReceivingAddressQuery extends BaseQuery<ReceivingAddressEntity, ReceivingAddressQuery> {
    ...
    public ReceivingAddressQuery(ParameterPair parameters) {
        super(ReceivingAddressMapping.Table_Name, parameters, ReceivingAddressEntity.class, ReceivingAddressQuery.class);
    }

    @Override
    public ReceivingAddressQuery selectId() {
        return this.select(ReceivingAddressMapping.id.column);
    }
