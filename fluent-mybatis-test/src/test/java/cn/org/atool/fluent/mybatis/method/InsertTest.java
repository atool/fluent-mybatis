...
public class InsertTest extends BaseTest {
    ...
    public void testInsert_NoAutoId() {
        ...
        db.table(t_no_auto_id).query().eqDataMap(DM.noAutoId.table(2)
    ...
    public void testInsert_NoAutoId_conflict() {
        db.table(t_no_auto_id).clean().insert(DM.noAutoId.initTable(1)
            .id.values("test-id-1")
            .column1.values("test")
        );
        want.exception(() -> {
    ...
    public void test_insert_noPrimary() {
        ...
        db.table(t_no_primary).query().eqDataMap(DM.noPrimary.table(1)
            .column1.values(23)
            .column2.values("test")
        );
    }
