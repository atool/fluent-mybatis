...
public class MybatisGeneratorTest {
    ...
    public void generate() {
        String outdir = System.getProperty("user.dir") + "/../mbplus/src/test/java";
        new MybatisGenerator("cn.org.atool.mbplus.demo")
                .setOutputDir(outdir, outdir, outdir)
                .setEntitySetChain(true)
                .setDataSource(url, "root", "password")
                .addBaseDaoInterface("MyCustomerInterface<${entity}, ${query}, ${update}>","cn.org.atool.mbplus.demo.MyCustomerInterface")
