...
import cn.org.atool.fluent.mybatis.annotation.EnumValue;
...
public class EnumTypeHandler<E extends Enum<?>> extends BaseTypeHandler<Enum<?>> {
    ...
    public EnumTypeHandler(Class<E> type) {
        ...
        if (IEnum.class.isAssignableFrom(type)) {
            ...
            this.method = TABLE_METHOD_OF_ENUM_TYPES.computeIfAbsent(type, k -> {
                ...
                return ReflectUtils.getMethod(this.type, field);
            });
        }
    }
    ...
    public void setNonNullParameter(PreparedStatement ps, int i, Enum<?> parameter, JdbcType jdbcType)
        ...
        try {
            ...
            throw FluentMybatisException.instance("Error: NoSuchMethod in %s.  Cause:", e, this.type.getName());
        }
    }
    ...
    public E getNullableResult(ResultSet rs, String columnName) throws SQLException {
        ...
        return valueOf(this.type, rs.getObject(columnName), this.method);
    }
    ...
    public E getNullableResult(ResultSet rs, int columnIndex) throws SQLException {
        ...
        return valueOf(this.type, rs.getObject(columnIndex), this.method);
    }
     ...
     * @return
     */
    static <E extends Enum<?>> E valueOf(Class<E> enumClass, Object value, Method method) {
        ...
        for (E e : es) {
            ...
            try {
                ...
                throw FluentMybatisException.instance("Error: NoSuchMethod in %s.  Cause:", e, enumClass.getName());
            }
