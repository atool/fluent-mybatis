...
public abstract class AbstractWrapper<T, R, Children extends AbstractWrapper<T, R, Children>> extends Wrapper<T>
    ...
    public Children last(boolean condition, String lastSql) {
        if (condition) {
            this.lastSql.setStringValue(Constants.SPACE + lastSql);
        }
        return typedThis;
    }
    ...
    protected Children likeValue(boolean condition, R column, Object val, SqlLike sqlLike) {
        return doIt(condition, () -> columnToString(column), LIKE, () -> formatSql("{0}", sqlLike.like(val)));
    }
    ...
    protected String columnToString(R column) {
        ...
        throw FluentMybatisException.instance("not support this column !");
    }
    ...
    public static String distinctSelect(String... columns) {
        return DISTINCT + String.join(Constants.COMMA, columns);
    }

    public static String distinctSelect(Class entityClass, Predicate<BaseFieldMeta> predicate) {
