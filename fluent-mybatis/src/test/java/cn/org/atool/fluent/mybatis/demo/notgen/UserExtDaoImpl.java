...
public class UserExtDaoImpl extends UserDaoImpl implements UserExtDao {
    ...
    public UserEntity selectOne(String likeName) {
        return super.query().and.userName.like(likeName).execute(super::selectOne);
    }
    ...
    public void deleteByQuery(String username) {
        super.query().and.userName.eq(username).execute(super::deleteByQuery);
    }

    @Override
    public void deleteByQuery(String... userNames) {
        super.query().and.userName.in(userNames).execute(super::deleteByQuery);
    }

    @Override
    public void updateUserNameById(String newUserName, long id) {
        super.update().set.userName.is(newUserName).and.id.eq(id).execute(super::update);
    }
}