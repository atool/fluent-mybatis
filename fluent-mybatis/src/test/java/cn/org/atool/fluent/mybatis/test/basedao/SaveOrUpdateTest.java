...
public class SaveOrUpdateTest extends BaseTest {
    ...
    public void test_saveOrUpdate() throws Exception {
        ...
        db.table(t_user).queryWhere("id=3").eqDataMap(TM.t_user.create(1).user_name.values("test_111").age.values(30));
    }
    ...
    public void test_saveOrUpdate_2() throws Exception {
        ...
        db.table(t_user).queryWhere("id=4").eqDataMap(TM.t_user.create(1).user_name.values("test_111").age.values(30));
    }
