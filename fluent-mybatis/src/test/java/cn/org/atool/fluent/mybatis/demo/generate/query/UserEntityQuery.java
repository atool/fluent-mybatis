...
public class UserEntityQuery extends AbstractWrapper<UserEntity, String, UserEntityQuery>
    ...
    @Override
    public UserEntityQuery select(PredicateField predicate) {
        this.entityClass = UserEntity.class;
    ...
    public UserEntityQuery distinct(PredicateField predicate) {
        this.entityClass = UserEntity.class;
        this.sqlSelect.setStringValue(distinctSelect(getCheckEntityClass(), predicate));
        return this;
    }

    public UserEntityQuery distinct(Class<UserEntity> entityClass, PredicateField predicate) {
