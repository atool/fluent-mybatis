...
public class NoAutoIdEntityQuery extends AbstractWrapper<NoAutoIdEntity, String, NoAutoIdEntityQuery>
    implements IEntityQuery<NoAutoIdEntityQuery, NoAutoIdEntity> {
    /**
     * 查询字段
     */
    ...
    @Override
    public NoAutoIdEntityQuery select(Predicate<BaseFieldMeta> predicate) {
        this.entityClass = NoAutoIdEntity.class;
    ...
    public NoAutoIdEntityQuery distinct(Predicate<BaseFieldMeta> predicate) {
        this.entityClass = NoAutoIdEntity.class;
        this.sqlSelect.setStringValue(super.distinctSelect(getCheckEntityClass(), predicate));
        return this;
    }

    public NoAutoIdEntityQuery distinct(Class<NoAutoIdEntity> entityClass, Predicate<BaseFieldMeta> predicate) {
