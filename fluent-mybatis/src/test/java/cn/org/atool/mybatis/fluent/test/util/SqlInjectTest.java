package cn.org.atool.mybatis.fluent.test.util;

import cn.org.atool.mybatis.fluent.util.SqlInject;
import org.junit.Test;
import org.test4j.junit.DataFrom;
import org.test4j.junit.Test4J;
import org.test4j.tools.datagen.DataProvider;

import static cn.org.atool.mybatis.fluent.util.SqlInject.assertNoInject;
import static cn.org.atool.mybatis.fluent.util.SqlInject.assertSimpleNoInject;
...
public class SqlInjectTest extends Test4J {
    ...
    public void test_assertSimpleNoInject() {
        assertSimpleNoInject("test", "--");
    }

    @Test(expected = RuntimeException.class)
    public void test_assertNoInject() {
        assertNoInject("test", "and");
    }
}